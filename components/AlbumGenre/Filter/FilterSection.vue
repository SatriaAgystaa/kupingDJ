<template>
  <div class="relative">
    ...
    <button 
      ...
      aria-label="Filter" 
      class="hover:text-[#A10501] hover:border-[#A10501] hover:bg-[#A10501]/10 transition-all duration-300 px-3 xs:px-3.5 sm:px-4 py-2 xs:py-2 sm:py-2 md:py-2 relative group flex items-center gap-1.5 sm:gap-2"
    ...
    >
      ...
      <div class="relative">
        <img 
          ...
          :class="{'filter-black group-hover:filter-none': !isOpen}"
        >
      </div>
