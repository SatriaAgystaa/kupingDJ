      ...
      <div class="flex flex-col lg:flex-row lg:items-start gap-8 sm:gap-10 md:gap-12">
        ...
        <div class="lg:w-1/3 lg:sticky lg:top-8">
          <div class="space-y-6 sm:space-y-8">
            <h2 class="text-2xl xs:text-2.5xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-4.5xl 2xl:text-5xl font-glancyr-medium text-black leading-tight tracking-tight">
