<template>
  <div class="min-h-screen h-screen grid grid-cols-1 lg:grid-cols-5 font-sans overflow-hidden">
    <!-- Left Column: Reset Password Form (2/5) -->
      ...
      <div class="flex-grow mb-10">
        ...
        <div class="flex-1">
          ...
          <form class="space-y-6">
            ...
            <!-- Confirm New Password with animation -->
            ...
            <div class="w-full transform transition-all duration-500 opacity-0 animate-fade-in" style="animation-delay: 600ms">
              <div class="flex w-full group font-glancyr-light hover:scale-[1.02] transition-all duration-300 active:scale-[0.98]">
                ...
                >
                  <span class="inline-block group-active:translate-y-0.5 transition-transform">RESET PASSWORD</span>
                </button>
                <div 
